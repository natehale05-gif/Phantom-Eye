...
class PortNum extends $pb.ProtobufEnum {
  ...
  static const PortNum ALERT_APP = PortNum._(11, _omitEnumNames ? '' : 'ALERT_APP');
  ///
  ///  Module/port for handling key verification requests.
  static const PortNum KEY_VERIFICATION_APP = PortNum._(12, _omitEnumNames ? '' : 'KEY_VERIFICATION_APP');
  ///
  ///  Module/port for handling primitive remote shell access.
  static const PortNum REMOTE_SHELL_APP = PortNum._(13, _omitEnumNames ? '' : 'REMOTE_SHELL_APP');
  ///
  ...
  ///  chain of messages.
  static const PortNum STORE_FORWARD_PLUSPLUS_APP = PortNum._(35, _omitEnumNames ? '' : 'STORE_FORWARD_PLUSPLUS_APP');
  ///
  ///  Node Status module
  ///  ENCODING: protobuf
  ///  This module allows setting an extra string of status for a node.
  ///  Broadcasts on change and on a timer, possibly once a day.
  static const PortNum NODE_STATUS_APP = PortNum._(36, _omitEnumNames ? '' : 'NODE_STATUS_APP');
  ///
  ...
  static const PortNum MESH_BEACON_APP = PortNum._(37, _omitEnumNames ? '' : 'MESH_BEACON_APP');
  ///
  ...
  static const PortNum POWERSTRESS_APP = PortNum._(74, _omitEnumNames ? '' : 'POWERSTRESS_APP');
  ///
  ///  LoraWAN Payload Transport
  ///  ENCODING: compact binary LoRaWAN uplink (10-byte RF metadata + PHY payload) - see LoRaWANBridgeModule
  static const PortNum LORAWAN_BRIDGE = PortNum._(75, _omitEnumNames ? '' : 'LORAWAN_BRIDGE');
  ///
  ///  Reticulum Network Stack Tunnel App
  ///  ENCODING: Fragmented RNS Packet. Handled by Meshtastic RNS interface
  static const PortNum RETICULUM_TUNNEL_APP = PortNum._(76, _omitEnumNames ? '' : 'RETICULUM_TUNNEL_APP');
  ///
  ///  App for transporting Cayenne Low Power Payload, popular for LoRaWAN sensor nodes. Offers ability to send
  ///  arbitrary telemetry over meshtastic that is not covered by telemetry.proto
  ///  ENCODING: CayenneLLP
  static const PortNum CAYENNE_APP = PortNum._(77, _omitEnumNames ? '' : 'CAYENNE_APP');
  ///
  ///  ATAK Plugin V2
  ///  Portnum for payloads from the official Meshtastic ATAK plugin using
  ///  TAKPacketV2 with zstd dictionary compression.
  static const PortNum ATAK_PLUGIN_V2 = PortNum._(78, _omitEnumNames ? '' : 'ATAK_PLUGIN_V2');
  /// signed firmware updates over lora.
  ///
  /// ENCODING: binary (ota-common transport frames)
  static const PortNum LORA_OTA_APP = PortNum._(79, _omitEnumNames ? '' : 'LORA_OTA_APP');
  ///
  ///  GroupAlarm integration
  ///  Used for transporting GroupAlarm-related messages between Meshtastic nodes
  ///  and companion applications/services.
  static const PortNum GROUPALARM_APP = PortNum._(112, _omitEnumNames ? '' : 'GROUPALARM_APP');
  ///
