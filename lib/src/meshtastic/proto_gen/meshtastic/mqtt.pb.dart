...
class ServiceEnvelope extends $pb.GeneratedMessage {
  ...
  factory ServiceEnvelope.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ServiceEnvelope.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceEnvelope', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..aOM<$0.MeshPacket>(1, _omitFieldNames ? '' : 'packet', subBuilder: $0.MeshPacket.create)
...
class MapReport extends $pb.GeneratedMessage {
  factory MapReport({
    ...
    if (numOnlineLocalNodes != null) result.numOnlineLocalNodes = numOnlineLocalNodes;
    if (hasOptedReportLocation != null) result.hasOptedReportLocation = hasOptedReportLocation;
    return result;
  }

  MapReport._();

  factory MapReport.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MapReport.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MapReport', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..e<$0.HardwareModel>(4, _omitFieldNames ? '' : 'hwModel', $pb.PbFieldType.OE, defaultOrMaker: $0.HardwareModel.UNSET, valueOf: $0.HardwareModel.valueOf, enumValues: $0.HardwareModel.values)
  ...
  @$pb.TagNumber(7)
  set modemPreset($1.Config_LoRaConfig_ModemPreset value) => $_setField(7, value);
  @$pb.TagNumber(7)
