...
class Config_DeviceConfig_Role extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_DeviceConfig_Role?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 12);
  static Config_DeviceConfig_Role? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_DeviceConfig_RebroadcastMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_DeviceConfig_RebroadcastMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 5);
  static Config_DeviceConfig_RebroadcastMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_DeviceConfig_BuzzerMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_DeviceConfig_BuzzerMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static Config_DeviceConfig_BuzzerMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_PositionConfig_GpsMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_PositionConfig_GpsMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Config_PositionConfig_GpsMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_NetworkConfig_AddressMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_NetworkConfig_AddressMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static Config_NetworkConfig_AddressMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_NetworkConfig_ProtocolFlags extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_NetworkConfig_ProtocolFlags?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static Config_NetworkConfig_ProtocolFlags? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_DisplayConfig_DeprecatedGpsCoordinateFormat extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_DisplayConfig_DeprecatedGpsCoordinateFormat?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 0);
  static Config_DisplayConfig_DeprecatedGpsCoordinateFormat? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const Config_DisplayConfig_DeprecatedGpsCoordinateFormat._(super.value, super.name);
}
...
class Config_DisplayConfig_DisplayUnits extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_DisplayConfig_DisplayUnits?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static Config_DisplayConfig_DisplayUnits? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_DisplayConfig_OledType extends $pb.ProtobufEnum {
  ...
  static const Config_DisplayConfig_OledType OLED_SH1107_ROTATED = Config_DisplayConfig_OledType._(5, _omitEnumNames ? '' : 'OLED_SH1107_ROTATED');
  ...
  static final $core.List<Config_DisplayConfig_OledType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 5);
  static Config_DisplayConfig_OledType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_DisplayConfig_DisplayMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_DisplayConfig_DisplayMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static Config_DisplayConfig_DisplayMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_DisplayConfig_CompassOrientation extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_DisplayConfig_CompassOrientation?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 7);
  static Config_DisplayConfig_CompassOrientation? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_LoRaConfig_RegionCode extends $pb.ProtobufEnum {
  ...
  static const Config_LoRaConfig_RegionCode ITU1_2M = Config_LoRaConfig_RegionCode._(27, _omitEnumNames ? '' : 'ITU1_2M');
  ///
  ///  ITU Region 2 Amateur Radio 2m band (144-148 MHz)
  static const Config_LoRaConfig_RegionCode ITU2_2M = Config_LoRaConfig_RegionCode._(28, _omitEnumNames ? '' : 'ITU2_2M');
  ///
  ///  EU 866MHz band (Band no. 47b of 2006/771/EC and subsequent amendments) for Non-specific short-range devices (SRD)
  static const Config_LoRaConfig_RegionCode EU_866 = Config_LoRaConfig_RegionCode._(29, _omitEnumNames ? '' : 'EU_866');
  ///
  ...
  static const Config_LoRaConfig_RegionCode EU_874 = Config_LoRaConfig_RegionCode._(30, _omitEnumNames ? '' : 'EU_874');
  static const Config_LoRaConfig_RegionCode EU_917 = Config_LoRaConfig_RegionCode._(31, _omitEnumNames ? '' : 'EU_917');
  ///
  ///  EU 868MHz band, with narrow presets
  static const Config_LoRaConfig_RegionCode EU_N_868 = Config_LoRaConfig_RegionCode._(32, _omitEnumNames ? '' : 'EU_N_868');
  ///
  ///  ITU Region 3 Amateur Radio 2m band (144-148 MHz)
  static const Config_LoRaConfig_RegionCode ITU3_2M = Config_LoRaConfig_RegionCode._(33, _omitEnumNames ? '' : 'ITU3_2M');
  ///
  ///  ITU Region 1 Amateur Radio 70cm band (430-440 MHz)
  static const Config_LoRaConfig_RegionCode ITU1_70CM = Config_LoRaConfig_RegionCode._(34, _omitEnumNames ? '' : 'ITU1_70CM');
  ///
  ///  ITU Region 2 Amateur Radio 70cm band (420-450 MHz)
  ///  Note: Some countries do not allocate 420-430 MHz or 440-450 MHz.
  ///  Check local law!
  static const Config_LoRaConfig_RegionCode ITU2_70CM = Config_LoRaConfig_RegionCode._(35, _omitEnumNames ? '' : 'ITU2_70CM');
  ///
  ///  ITU Region 3 Amateur Radio 70cm band (430-450 MHz)
  ///  Note: Some countries do not allocate 440-450 MHz. Check local law!
  static const Config_LoRaConfig_RegionCode ITU3_70CM = Config_LoRaConfig_RegionCode._(36, _omitEnumNames ? '' : 'ITU3_70CM');
  ///
  ///  ITU Region 2 Amateur Radio 1.25m '125cm' band (220-225 MHz)
  ///  Note: Some countries do not allocate 220-222 MHz (Ex: USA/Canada).
  ///  Check local law!
  static const Config_LoRaConfig_RegionCode ITU2_125CM = Config_LoRaConfig_RegionCode._(37, _omitEnumNames ? '' : 'ITU2_125CM');
  ...
  static final $core.List<Config_LoRaConfig_RegionCode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 37);
  static Config_LoRaConfig_RegionCode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_LoRaConfig_ModemPreset extends $pb.ProtobufEnum {
  ...
  static const Config_LoRaConfig_ModemPreset LONG_TURBO = Config_LoRaConfig_ModemPreset._(9, _omitEnumNames ? '' : 'LONG_TURBO');
  ///
  ///  Lite Fast
  ...
  static const Config_LoRaConfig_ModemPreset LITE_FAST = Config_LoRaConfig_ModemPreset._(10, _omitEnumNames ? '' : 'LITE_FAST');
  ///
  ///  Lite Slow
  ...
  static const Config_LoRaConfig_ModemPreset LITE_SLOW = Config_LoRaConfig_ModemPreset._(11, _omitEnumNames ? '' : 'LITE_SLOW');
  ///
  ///  Narrow Fast
  ...
  static const Config_LoRaConfig_ModemPreset NARROW_FAST = Config_LoRaConfig_ModemPreset._(12, _omitEnumNames ? '' : 'NARROW_FAST');
  ///
  ///  Narrow Slow
  ...
  static const Config_LoRaConfig_ModemPreset NARROW_SLOW = Config_LoRaConfig_ModemPreset._(13, _omitEnumNames ? '' : 'NARROW_SLOW');
  ///
  ///  Tiny Fast
  ...
  ///  Comparable link budget and data rate to LONG_FAST.
  static const Config_LoRaConfig_ModemPreset TINY_FAST = Config_LoRaConfig_ModemPreset._(14, _omitEnumNames ? '' : 'TINY_FAST');
  ///
  ///  Tiny Slow
  ///  Preset optimized for compliance with Amateur Radio restrictions with 20kHz bandwidth.
  ///  Many regions limit data transmission bandwidth in lower amateur bands (2 Meter).
  ...
  static const Config_LoRaConfig_ModemPreset TINY_SLOW = Config_LoRaConfig_ModemPreset._(15, _omitEnumNames ? '' : 'TINY_SLOW');
  ///
  ///  Medium Range - Turbo
  ///  This preset performs similarly to MEDIUM_FAST, but with 500kHz bandwidth.
  ///  It is not legal to use in all regions due to this wider bandwidth.
  static const Config_LoRaConfig_ModemPreset MEDIUM_TURBO = Config_LoRaConfig_ModemPreset._(16, _omitEnumNames ? '' : 'MEDIUM_TURBO');
  ...
  static final $core.List<Config_LoRaConfig_ModemPreset?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 16);
  static Config_LoRaConfig_ModemPreset? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_LoRaConfig_FEM_LNA_Mode extends $pb.ProtobufEnum {
  ...
  static const Config_LoRaConfig_FEM_LNA_Mode DISABLED = Config_LoRaConfig_FEM_LNA_Mode._(0, _omitEnumNames ? '' : 'DISABLED');
  ///
  ///  FEM_LNA is present and enabled
  static const Config_LoRaConfig_FEM_LNA_Mode ENABLED = Config_LoRaConfig_FEM_LNA_Mode._(1, _omitEnumNames ? '' : 'ENABLED');
  ///
  ///  FEM_LNA is not present on the device
  static const Config_LoRaConfig_FEM_LNA_Mode NOT_PRESENT = Config_LoRaConfig_FEM_LNA_Mode._(2, _omitEnumNames ? '' : 'NOT_PRESENT');

  static const $core.List<Config_LoRaConfig_FEM_LNA_Mode> values = <Config_LoRaConfig_FEM_LNA_Mode> [
    DISABLED,
    ENABLED,
    NOT_PRESENT,
  ];

  static final $core.List<Config_LoRaConfig_FEM_LNA_Mode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Config_LoRaConfig_FEM_LNA_Mode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Config_BluetoothConfig_PairingMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<Config_BluetoothConfig_PairingMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Config_BluetoothConfig_PairingMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
