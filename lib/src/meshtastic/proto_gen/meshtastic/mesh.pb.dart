...
class Position extends $pb.GeneratedMessage {
  factory Position({
    ...
    if (timestampMillisAdjust != null) result.timestampMillisAdjust = timestampMillisAdjust;
    if (altitudeHae != null) result.altitudeHae = altitudeHae;
    if (altitudeGeoidalSeparation != null) result.altitudeGeoidalSeparation = altitudeGeoidalSeparation;
...
class RouteDiscovery extends $pb.GeneratedMessage {
  ...
  factory RouteDiscovery.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory RouteDiscovery.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Routing extends $pb.GeneratedMessage {
  ...
  factory Routing.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Routing.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Data extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Data', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..e<$6.PortNum>(1, _omitFieldNames ? '' : 'portnum', $pb.PbFieldType.OE, defaultOrMaker: $6.PortNum.UNKNOWN_APP, valueOf: $6.PortNum.valueOf, enumValues: $6.PortNum.values)
    ...
    ..a<$core.List<$core.int>>(10, _omitFieldNames ? '' : 'xeddsaSignature', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
...
class KeyVerification extends $pb.GeneratedMessage {
  ...
  factory KeyVerification.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory KeyVerification.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyVerification', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'nonce', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'hash1', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'hash2', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  KeyVerification copyWith(void Function(KeyVerification) updates) => super.copyWith((message) => updates(message as KeyVerification)) as KeyVerification;
  ...
  static $pb.PbList<KeyVerification> createRepeated() => $pb.PbList<KeyVerification>();
  @$core.pragma('dart2js:noInline')
  static KeyVerification getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KeyVerification>(create);
...
class StoreForwardPlusPlus extends $pb.GeneratedMessage {
  factory StoreForwardPlusPlus({
    ...
    if (encapsulatedRxtime != null) result.encapsulatedRxtime = encapsulatedRxtime;
  ...
  factory StoreForwardPlusPlus.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory StoreForwardPlusPlus.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StoreForwardPlusPlus', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..e<StoreForwardPlusPlus_SFPP_message_type>(1, _omitFieldNames ? '' : 'sfppMessageType', $pb.PbFieldType.OE, defaultOrMaker: StoreForwardPlusPlus_SFPP_message_type.CANON_ANNOUNCE, valueOf: StoreForwardPlusPlus_SFPP_message_type.valueOf, enumValues: StoreForwardPlusPlus_SFPP_message_type.values)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'messageHash', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'commitHash', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'rootHash', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'message', $pb.PbFieldType.OY)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'encapsulatedId', $pb.PbFieldType.OU3)
    ..a<$core.int>(7, _omitFieldNames ? '' : 'encapsulatedTo', $pb.PbFieldType.OU3)
    ..a<$core.int>(8, _omitFieldNames ? '' : 'encapsulatedFrom', $pb.PbFieldType.OU3)
    ..a<$core.int>(9, _omitFieldNames ? '' : 'encapsulatedRxtime', $pb.PbFieldType.OU3)
    ..a<$core.int>(10, _omitFieldNames ? '' : 'chainCount', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  StoreForwardPlusPlus clone() => StoreForwardPlusPlus()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  StoreForwardPlusPlus copyWith(void Function(StoreForwardPlusPlus) updates) => super.copyWith((message) => updates(message as StoreForwardPlusPlus)) as StoreForwardPlusPlus;
  ...
  static $pb.PbList<StoreForwardPlusPlus> createRepeated() => $pb.PbList<StoreForwardPlusPlus>();
  @$core.pragma('dart2js:noInline')
  static StoreForwardPlusPlus getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StoreForwardPlusPlus>(create);
  ...
  @$pb.TagNumber(1)
  set sfppMessageType(StoreForwardPlusPlus_SFPP_message_type value) => $_setField(1, value);
  @$pb.TagNumber(1)
...
class RemoteShell extends $pb.GeneratedMessage {
  ...
  factory RemoteShell.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory RemoteShell.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteShell', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..e<RemoteShell_OpCode>(1, _omitFieldNames ? '' : 'op', $pb.PbFieldType.OE, defaultOrMaker: RemoteShell_OpCode.OP_UNSET, valueOf: RemoteShell_OpCode.valueOf, enumValues: RemoteShell_OpCode.values)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'sessionId', $pb.PbFieldType.OU3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'seq', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'ackSeq', $pb.PbFieldType.OU3)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'payload', $pb.PbFieldType.OY)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'cols', $pb.PbFieldType.OU3)
    ..a<$core.int>(7, _omitFieldNames ? '' : 'rows', $pb.PbFieldType.OU3)
    ..a<$core.int>(8, _omitFieldNames ? '' : 'flags', $pb.PbFieldType.OU3)
    ..a<$core.int>(9, _omitFieldNames ? '' : 'lastTxSeq', $pb.PbFieldType.OU3)
    ..a<$core.int>(10, _omitFieldNames ? '' : 'lastRxSeq', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RemoteShell clone() => RemoteShell()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RemoteShell copyWith(void Function(RemoteShell) updates) => super.copyWith((message) => updates(message as RemoteShell)) as RemoteShell;
  ...
  static $pb.PbList<RemoteShell> createRepeated() => $pb.PbList<RemoteShell>();
  @$core.pragma('dart2js:noInline')
  static RemoteShell getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RemoteShell>(create);
...
class BoundingBox extends $pb.GeneratedMessage {
  ...
  factory BoundingBox.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory BoundingBox.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BoundingBox', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'longitudeWestI', $pb.PbFieldType.OSF3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'latitudeSouthI', $pb.PbFieldType.OSF3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'longitudeEastI', $pb.PbFieldType.OSF3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'latitudeNorthI', $pb.PbFieldType.OSF3)
    ..hasRequiredFields = false
  ;
...
class Waypoint extends $pb.GeneratedMessage {
  factory Waypoint({
    ...
    if (notifyFavoritesOnly != null) result.notifyFavoritesOnly = notifyFavoritesOnly;
    return result;
  }

  Waypoint._();

  factory Waypoint.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Waypoint.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Waypoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..a<$core.int>(9, _omitFieldNames ? '' : 'geofenceRadius', $pb.PbFieldType.OU3)
    ..aOM<BoundingBox>(10, _omitFieldNames ? '' : 'boundingBox', subBuilder: BoundingBox.create)
...
class StatusMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
...
class MqttClientProxyMessage extends $pb.GeneratedMessage {
  ...
  factory MqttClientProxyMessage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MqttClientProxyMessage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class MeshPacket extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (transportMechanism != null) result.transportMechanism = transportMechanism;
  ...
  factory MeshPacket.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MeshPacket.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MeshPacket', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(16, _omitFieldNames ? '' : 'publicKey', $pb.PbFieldType.OY)
    ...
    ..e<MeshPacket_TransportMechanism>(21, _omitFieldNames ? '' : 'transportMechanism', $pb.PbFieldType.OE, defaultOrMaker: MeshPacket_TransportMechanism.TRANSPORT_INTERNAL, valueOf: MeshPacket_TransportMechanism.valueOf, enumValues: MeshPacket_TransportMechanism.values)
  ...
  @$pb.TagNumber(21)
  set transportMechanism(MeshPacket_TransportMechanism value) => $_setField(21, value);
  @$pb.TagNumber(21)
...
class NodeInfo extends $pb.GeneratedMessage {
  factory NodeInfo({
    ...
    if (isKeyManuallyVerified != null) result.isKeyManuallyVerified = isKeyManuallyVerified;
  ...
  factory NodeInfo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory NodeInfo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class MyNodeInfo extends $pb.GeneratedMessage {
  ...
  factory MyNodeInfo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MyNodeInfo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MyNodeInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(12, _omitFieldNames ? '' : 'deviceId', $pb.PbFieldType.OY)
    ..aOS(13, _omitFieldNames ? '' : 'pioEnv')
    ..e<FirmwareEdition>(14, _omitFieldNames ? '' : 'firmwareEdition', $pb.PbFieldType.OE, defaultOrMaker: FirmwareEdition.VANILLA, valueOf: FirmwareEdition.valueOf, enumValues: FirmwareEdition.values)
    ..a<$core.int>(15, _omitFieldNames ? '' : 'nodedbCount', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
...
class LogRecord extends $pb.GeneratedMessage {
  ...
  factory LogRecord.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LogRecord.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class QueueStatus extends $pb.GeneratedMessage {
  ...
  factory QueueStatus.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory QueueStatus.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class FromRadio extends $pb.GeneratedMessage {
  factory FromRadio({
    ...
    if (mqttClientProxyMessage != null) result.mqttClientProxyMessage = mqttClientProxyMessage;
    if (fileInfo != null) result.fileInfo = fileInfo;
    if (clientNotification != null) result.clientNotification = clientNotification;
  ...
  factory FromRadio.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory FromRadio.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FromRadio', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..aOM<FileInfo>(15, _omitFieldNames ? '' : 'fileInfo', protoName: 'fileInfo', subBuilder: FileInfo.create)
    ..aOM<ClientNotification>(16, _omitFieldNames ? '' : 'clientNotification', protoName: 'clientNotification', subBuilder: ClientNotification.create)
    ..aOM<$5.DeviceUIConfig>(17, _omitFieldNames ? '' : 'deviceuiConfig', protoName: 'deviceuiConfig', subBuilder: $5.DeviceUIConfig.create)
    ..aOM<LockdownStatus>(18, _omitFieldNames ? '' : 'lockdownStatus', subBuilder: LockdownStatus.create)
    ..aOM<LoRaRegionPresetMap>(19, _omitFieldNames ? '' : 'regionPresets', subBuilder: LoRaRegionPresetMap.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(14)
  set mqttClientProxyMessage(MqttClientProxyMessage value) => $_setField(14, value);
  @$pb.TagNumber(14)
...
class LockdownStatus extends $pb.GeneratedMessage {
  ...
  factory LockdownStatus.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LockdownStatus.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LockdownStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..e<LockdownStatus_State>(1, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: LockdownStatus_State.STATE_UNSPECIFIED, valueOf: LockdownStatus_State.valueOf, enumValues: LockdownStatus_State.values)
    ..aOS(2, _omitFieldNames ? '' : 'lockReason')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'bootsRemaining', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'validUntilEpoch', $pb.PbFieldType.OU3)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'backoffSeconds', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LockdownStatus clone() => LockdownStatus()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LockdownStatus copyWith(void Function(LockdownStatus) updates) => super.copyWith((message) => updates(message as LockdownStatus)) as LockdownStatus;
  ...
  static $pb.PbList<LockdownStatus> createRepeated() => $pb.PbList<LockdownStatus>();
  @$core.pragma('dart2js:noInline')
  static LockdownStatus getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LockdownStatus>(create);
...
class ClientNotification extends $pb.GeneratedMessage {
  factory ClientNotification({
    ...
    if (level != null) result.level = level;
    if (message != null) result.message = message;
    if (keyVerificationNumberInform != null) result.keyVerificationNumberInform = keyVerificationNumberInform;
    if (keyVerificationNumberRequest != null) result.keyVerificationNumberRequest = keyVerificationNumberRequest;
    if (keyVerificationFinal != null) result.keyVerificationFinal = keyVerificationFinal;
    if (duplicatedPublicKey != null) result.duplicatedPublicKey = duplicatedPublicKey;
  ...
  factory ClientNotification.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ClientNotification.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static const $core.Map<$core.int, ClientNotification_PayloadVariant> _ClientNotification_PayloadVariantByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientNotification', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..oo(0, [11, 12, 13, 14, 15])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'replyId', $pb.PbFieldType.OU3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'time', $pb.PbFieldType.OF3)
    ..e<LogRecord_Level>(3, _omitFieldNames ? '' : 'level', $pb.PbFieldType.OE, defaultOrMaker: LogRecord_Level.UNSET, valueOf: LogRecord_Level.valueOf, enumValues: LogRecord_Level.values)
    ..aOS(4, _omitFieldNames ? '' : 'message')
    ..aOM<KeyVerificationNumberInform>(11, _omitFieldNames ? '' : 'keyVerificationNumberInform', subBuilder: KeyVerificationNumberInform.create)
    ..aOM<KeyVerificationNumberRequest>(12, _omitFieldNames ? '' : 'keyVerificationNumberRequest', subBuilder: KeyVerificationNumberRequest.create)
    ..aOM<KeyVerificationFinal>(13, _omitFieldNames ? '' : 'keyVerificationFinal', subBuilder: KeyVerificationFinal.create)
    ..aOM<DuplicatedPublicKey>(14, _omitFieldNames ? '' : 'duplicatedPublicKey', subBuilder: DuplicatedPublicKey.create)
    ..aOM<LowEntropyKey>(15, _omitFieldNames ? '' : 'lowEntropyKey', subBuilder: LowEntropyKey.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ClientNotification copyWith(void Function(ClientNotification) updates) => super.copyWith((message) => updates(message as ClientNotification)) as ClientNotification;
  ...
  static $pb.PbList<ClientNotification> createRepeated() => $pb.PbList<ClientNotification>();
  @$core.pragma('dart2js:noInline')
  static ClientNotification getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ClientNotification>(create);
  static ClientNotification? _defaultInstance;

  ClientNotification_PayloadVariant whichPayloadVariant() => _ClientNotification_PayloadVariantByTag[$_whichOneof(0)]!;
  void clearPayloadVariant() => $_clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(11)
  set keyVerificationNumberInform(KeyVerificationNumberInform value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasKeyVerificationNumberInform() => $_has(4);
  @$pb.TagNumber(11)
  void clearKeyVerificationNumberInform() => $_clearField(11);
  @$pb.TagNumber(11)
  KeyVerificationNumberInform ensureKeyVerificationNumberInform() => $_ensure(4);

  @$pb.TagNumber(12)
  KeyVerificationNumberRequest get keyVerificationNumberRequest => $_getN(5);
  @$pb.TagNumber(12)
  set keyVerificationNumberRequest(KeyVerificationNumberRequest value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasKeyVerificationNumberRequest() => $_has(5);
  @$pb.TagNumber(12)
  void clearKeyVerificationNumberRequest() => $_clearField(12);
  @$pb.TagNumber(12)
  KeyVerificationNumberRequest ensureKeyVerificationNumberRequest() => $_ensure(5);
...
class KeyVerificationNumberInform extends $pb.GeneratedMessage {
  ...
  factory KeyVerificationNumberInform.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory KeyVerificationNumberInform.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyVerificationNumberInform', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'nonce', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(2, _omitFieldNames ? '' : 'remoteLongname')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'securityNumber', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  KeyVerificationNumberInform clone() => KeyVerificationNumberInform()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  KeyVerificationNumberInform copyWith(void Function(KeyVerificationNumberInform) updates) => super.copyWith((message) => updates(message as KeyVerificationNumberInform)) as KeyVerificationNumberInform;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static KeyVerificationNumberInform create() => KeyVerificationNumberInform._();
  @$core.override
  KeyVerificationNumberInform createEmptyInstance() => create();
  static $pb.PbList<KeyVerificationNumberInform> createRepeated() => $pb.PbList<KeyVerificationNumberInform>();
  @$core.pragma('dart2js:noInline')
  static KeyVerificationNumberInform getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KeyVerificationNumberInform>(create);
...
class KeyVerificationNumberRequest extends $pb.GeneratedMessage {
  ...
  factory KeyVerificationNumberRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory KeyVerificationNumberRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyVerificationNumberRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'nonce', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(2, _omitFieldNames ? '' : 'remoteLongname')
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  KeyVerificationNumberRequest clone() => KeyVerificationNumberRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  KeyVerificationNumberRequest copyWith(void Function(KeyVerificationNumberRequest) updates) => super.copyWith((message) => updates(message as KeyVerificationNumberRequest)) as KeyVerificationNumberRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static KeyVerificationNumberRequest create() => KeyVerificationNumberRequest._();
  @$core.override
  KeyVerificationNumberRequest createEmptyInstance() => create();
  static $pb.PbList<KeyVerificationNumberRequest> createRepeated() => $pb.PbList<KeyVerificationNumberRequest>();
  @$core.pragma('dart2js:noInline')
  static KeyVerificationNumberRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KeyVerificationNumberRequest>(create);
...
class KeyVerificationFinal extends $pb.GeneratedMessage {
  factory KeyVerificationFinal({
    ...
    if (verificationCharacters != null) result.verificationCharacters = verificationCharacters;
    return result;
  }

  KeyVerificationFinal._();

  factory KeyVerificationFinal.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory KeyVerificationFinal.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyVerificationFinal', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'nonce', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(2, _omitFieldNames ? '' : 'remoteLongname')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  KeyVerificationFinal clone() => KeyVerificationFinal()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  KeyVerificationFinal copyWith(void Function(KeyVerificationFinal) updates) => super.copyWith((message) => updates(message as KeyVerificationFinal)) as KeyVerificationFinal;
  ...
  static $pb.PbList<KeyVerificationFinal> createRepeated() => $pb.PbList<KeyVerificationFinal>();
  @$core.pragma('dart2js:noInline')
  static KeyVerificationFinal getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<KeyVerificationFinal>(create);
...
class DuplicatedPublicKey extends $pb.GeneratedMessage {
  ...
  factory DuplicatedPublicKey.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DuplicatedPublicKey.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DuplicatedPublicKey', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DuplicatedPublicKey copyWith(void Function(DuplicatedPublicKey) updates) => super.copyWith((message) => updates(message as DuplicatedPublicKey)) as DuplicatedPublicKey;
  ...
  static $pb.PbList<DuplicatedPublicKey> createRepeated() => $pb.PbList<DuplicatedPublicKey>();
  @$core.pragma('dart2js:noInline')
  static DuplicatedPublicKey getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DuplicatedPublicKey>(create);
...
class LowEntropyKey extends $pb.GeneratedMessage {
  ...
  factory LowEntropyKey.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LowEntropyKey.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LowEntropyKey', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LowEntropyKey copyWith(void Function(LowEntropyKey) updates) => super.copyWith((message) => updates(message as LowEntropyKey)) as LowEntropyKey;
  ...
  static $pb.PbList<LowEntropyKey> createRepeated() => $pb.PbList<LowEntropyKey>();
  @$core.pragma('dart2js:noInline')
  static LowEntropyKey getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LowEntropyKey>(create);
...
class FileInfo extends $pb.GeneratedMessage {
  ...
  factory FileInfo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory FileInfo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
...
class ToRadio extends $pb.GeneratedMessage {
  ...
  factory ToRadio.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ToRadio.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(6)
  set mqttClientProxyMessage(MqttClientProxyMessage value) => $_setField(6, value);
  @$pb.TagNumber(6)
...
class Compressed extends $pb.GeneratedMessage {
  ...
  factory Compressed.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Compressed.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class NeighborInfo extends $pb.GeneratedMessage {
  factory NeighborInfo({
    ...
    if (nodeBroadcastIntervalSecs != null) result.nodeBroadcastIntervalSecs = nodeBroadcastIntervalSecs;
  ...
  factory NeighborInfo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory NeighborInfo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(3)
  set nodeBroadcastIntervalSecs($core.int value) => $_setUnsignedInt32(2, value);
  @$pb.TagNumber(3)
...
class Neighbor extends $pb.GeneratedMessage {
  ...
  factory Neighbor.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Neighbor.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(4)
  set nodeBroadcastIntervalSecs($core.int value) => $_setUnsignedInt32(3, value);
  @$pb.TagNumber(4)
...
class DeviceMetadata extends $pb.GeneratedMessage {
  factory DeviceMetadata({
    ...
    if (deviceStateVersion != null) result.deviceStateVersion = deviceStateVersion;
  ...
  factory DeviceMetadata.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DeviceMetadata.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeviceMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..a<$core.int>(12, _omitFieldNames ? '' : 'excludedModules', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
...
class LoRaPresetGroup extends $pb.GeneratedMessage {
  ...
  factory LoRaPresetGroup.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LoRaPresetGroup.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoRaPresetGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..pc<$1.Config_LoRaConfig_ModemPreset>(1, _omitFieldNames ? '' : 'presets', $pb.PbFieldType.KE, valueOf: $1.Config_LoRaConfig_ModemPreset.valueOf, enumValues: $1.Config_LoRaConfig_ModemPreset.values, defaultEnumValue: $1.Config_LoRaConfig_ModemPreset.LONG_FAST)
    ..e<$1.Config_LoRaConfig_ModemPreset>(2, _omitFieldNames ? '' : 'defaultPreset', $pb.PbFieldType.OE, defaultOrMaker: $1.Config_LoRaConfig_ModemPreset.LONG_FAST, valueOf: $1.Config_LoRaConfig_ModemPreset.valueOf, enumValues: $1.Config_LoRaConfig_ModemPreset.values)
    ..aOB(3, _omitFieldNames ? '' : 'licensedOnly')
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LoRaPresetGroup clone() => LoRaPresetGroup()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LoRaPresetGroup copyWith(void Function(LoRaPresetGroup) updates) => super.copyWith((message) => updates(message as LoRaPresetGroup)) as LoRaPresetGroup;
  ...
  static $pb.PbList<LoRaPresetGroup> createRepeated() => $pb.PbList<LoRaPresetGroup>();
  @$core.pragma('dart2js:noInline')
  static LoRaPresetGroup getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LoRaPresetGroup>(create);
  ...
  @$pb.TagNumber(2)
  set defaultPreset($1.Config_LoRaConfig_ModemPreset value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class LoRaRegionPresets extends $pb.GeneratedMessage {
  ...
  factory LoRaRegionPresets.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LoRaRegionPresets.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoRaRegionPresets', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..e<$1.Config_LoRaConfig_RegionCode>(1, _omitFieldNames ? '' : 'region', $pb.PbFieldType.OE, defaultOrMaker: $1.Config_LoRaConfig_RegionCode.UNSET, valueOf: $1.Config_LoRaConfig_RegionCode.valueOf, enumValues: $1.Config_LoRaConfig_RegionCode.values)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'groupIndex', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LoRaRegionPresets clone() => LoRaRegionPresets()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LoRaRegionPresets copyWith(void Function(LoRaRegionPresets) updates) => super.copyWith((message) => updates(message as LoRaRegionPresets)) as LoRaRegionPresets;
  ...
  static $pb.PbList<LoRaRegionPresets> createRepeated() => $pb.PbList<LoRaRegionPresets>();
  @$core.pragma('dart2js:noInline')
  static LoRaRegionPresets getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LoRaRegionPresets>(create);
...
class LoRaRegionPresetMap extends $pb.GeneratedMessage {
  ...
  factory LoRaRegionPresetMap.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LoRaRegionPresetMap.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoRaRegionPresetMap', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..pc<LoRaPresetGroup>(1, _omitFieldNames ? '' : 'groups', $pb.PbFieldType.PM, subBuilder: LoRaPresetGroup.create)
    ..pc<LoRaRegionPresets>(2, _omitFieldNames ? '' : 'regionGroups', $pb.PbFieldType.PM, subBuilder: LoRaRegionPresets.create)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LoRaRegionPresetMap clone() => LoRaRegionPresetMap()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LoRaRegionPresetMap copyWith(void Function(LoRaRegionPresetMap) updates) => super.copyWith((message) => updates(message as LoRaRegionPresetMap)) as LoRaRegionPresetMap;
  ...
  static $pb.PbList<LoRaRegionPresetMap> createRepeated() => $pb.PbList<LoRaRegionPresetMap>();
  @$core.pragma('dart2js:noInline')
  static LoRaRegionPresetMap getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LoRaRegionPresetMap>(create);
...
class Heartbeat extends $pb.GeneratedMessage {
  ...
  factory Heartbeat.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Heartbeat.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class NodeRemoteHardwarePin extends $pb.GeneratedMessage {
  ...
  factory NodeRemoteHardwarePin.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory NodeRemoteHardwarePin.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class ChunkedPayload extends $pb.GeneratedMessage {
  ...
  factory ChunkedPayload.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ChunkedPayload.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChunkedPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'payloadChunk', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ChunkedPayload copyWith(void Function(ChunkedPayload) updates) => super.copyWith((message) => updates(message as ChunkedPayload)) as ChunkedPayload;
  ...
  static $pb.PbList<ChunkedPayload> createRepeated() => $pb.PbList<ChunkedPayload>();
  @$core.pragma('dart2js:noInline')
  static ChunkedPayload getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChunkedPayload>(create);
...
class resend_chunks extends $pb.GeneratedMessage {
  ...
  factory resend_chunks.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory resend_chunks.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'resend_chunks', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  resend_chunks copyWith(void Function(resend_chunks) updates) => super.copyWith((message) => updates(message as resend_chunks)) as resend_chunks;
  ...
  static $pb.PbList<resend_chunks> createRepeated() => $pb.PbList<resend_chunks>();
  @$core.pragma('dart2js:noInline')
  static resend_chunks getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<resend_chunks>(create);
...
class ChunkedPayloadResponse extends $pb.GeneratedMessage {
  ...
  factory ChunkedPayloadResponse.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ChunkedPayloadResponse.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static const $core.Map<$core.int, ChunkedPayloadResponse_PayloadVariant> _ChunkedPayloadResponse_PayloadVariantByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChunkedPayloadResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'payloadId', $pb.PbFieldType.OU3)
    ..aOB(2, _omitFieldNames ? '' : 'requestTransfer')
    ..aOB(3, _omitFieldNames ? '' : 'acceptTransfer')
    ..aOM<resend_chunks>(4, _omitFieldNames ? '' : 'resendChunks', subBuilder: resend_chunks.create)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ChunkedPayloadResponse clone() => ChunkedPayloadResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ChunkedPayloadResponse copyWith(void Function(ChunkedPayloadResponse) updates) => super.copyWith((message) => updates(message as ChunkedPayloadResponse)) as ChunkedPayloadResponse;
  ...
  static $pb.PbList<ChunkedPayloadResponse> createRepeated() => $pb.PbList<ChunkedPayloadResponse>();
  @$core.pragma('dart2js:noInline')
  static ChunkedPayloadResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChunkedPayloadResponse>(create);
  static ChunkedPayloadResponse? _defaultInstance;

  ChunkedPayloadResponse_PayloadVariant whichPayloadVariant() => _ChunkedPayloadResponse_PayloadVariantByTag[$_whichOneof(0)]!;
  void clearPayloadVariant() => $_clearField($_whichOneof(0));
