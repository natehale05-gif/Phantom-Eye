...
class Channel_Role extends $pb.ProtobufEnum {
  ...
  static final $core.List<Channel_Role?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Channel_Role? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
