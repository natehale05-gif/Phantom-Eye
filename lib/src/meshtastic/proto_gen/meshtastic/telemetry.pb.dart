...
class DeviceMetrics extends $pb.GeneratedMessage {
  factory DeviceMetrics({
    ...
    if (channelUtilization != null) result.channelUtilization = channelUtilization;
  ...
  factory DeviceMetrics.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DeviceMetrics.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class EnvironmentMetrics extends $pb.GeneratedMessage {
  factory EnvironmentMetrics({
    ...
    if (barometricPressure != null) result.barometricPressure = barometricPressure;
    ...
    if (oneWireTemperature != null) result.oneWireTemperature.addAll(oneWireTemperature);
    return result;
  }

  EnvironmentMetrics._();

  factory EnvironmentMetrics.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory EnvironmentMetrics.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnvironmentMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..p<$core.double>(23, _omitFieldNames ? '' : 'oneWireTemperature', $pb.PbFieldType.KF)
    ..hasRequiredFields = false
  ;
...
class PowerMetrics extends $pb.GeneratedMessage {
  ...
  factory PowerMetrics.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory PowerMetrics.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class AirQualityMetrics extends $pb.GeneratedMessage {
  factory AirQualityMetrics({
    ...
    if (pm100Environmental != null) result.pm100Environmental = pm100Environmental;
  ...
  factory AirQualityMetrics.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AirQualityMetrics.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class LocalStats extends $pb.GeneratedMessage {
  factory LocalStats({
    ...
    if (numTxRelayCanceled != null) result.numTxRelayCanceled = numTxRelayCanceled;
  ...
  factory LocalStats.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LocalStats.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..a<$core.int>(15, _omitFieldNames ? '' : 'noiseFloor', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class TrafficManagementStats extends $pb.GeneratedMessage {
  factory TrafficManagementStats({
    ...
    if (positionDedupDrops != null) result.positionDedupDrops = positionDedupDrops;
    ...
    if (unknownPacketDrops != null) result.unknownPacketDrops = unknownPacketDrops;
    if (hopExhaustedPackets != null) result.hopExhaustedPackets = hopExhaustedPackets;
    if (routerHopsPreserved != null) result.routerHopsPreserved = routerHopsPreserved;
    return result;
  }

  TrafficManagementStats._();

  factory TrafficManagementStats.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory TrafficManagementStats.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrafficManagementStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'packetsInspected', $pb.PbFieldType.OU3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'positionDedupDrops', $pb.PbFieldType.OU3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'nodeinfoCacheHits', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'rateLimitDrops', $pb.PbFieldType.OU3)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'unknownPacketDrops', $pb.PbFieldType.OU3)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'hopExhaustedPackets', $pb.PbFieldType.OU3)
    ..a<$core.int>(7, _omitFieldNames ? '' : 'routerHopsPreserved', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TrafficManagementStats clone() => TrafficManagementStats()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TrafficManagementStats copyWith(void Function(TrafficManagementStats) updates) => super.copyWith((message) => updates(message as TrafficManagementStats)) as TrafficManagementStats;
  ...
  static $pb.PbList<TrafficManagementStats> createRepeated() => $pb.PbList<TrafficManagementStats>();
  @$core.pragma('dart2js:noInline')
  static TrafficManagementStats getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TrafficManagementStats>(create);
...
class HealthMetrics extends $pb.GeneratedMessage {
  ...
  factory HealthMetrics.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory HealthMetrics.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class HostMetrics extends $pb.GeneratedMessage {
  ...
  factory HostMetrics.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory HostMetrics.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class Telemetry extends $pb.GeneratedMessage {
  factory Telemetry({
    ...
    if (environmentMetrics != null) result.environmentMetrics = environmentMetrics;
    ...
    if (trafficManagementStats != null) result.trafficManagementStats = trafficManagementStats;
    return result;
  }

  Telemetry._();

  factory Telemetry.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Telemetry.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Telemetry', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ...
    ..aOM<TrafficManagementStats>(9, _omitFieldNames ? '' : 'trafficManagementStats', subBuilder: TrafficManagementStats.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  set trafficManagementStats(TrafficManagementStats value) => $_setField(9, value);
  @$pb.TagNumber(9)
...
class Nau7802Config extends $pb.GeneratedMessage {
  ...
  factory Nau7802Config.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Nau7802Config.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class SEN5XState extends $pb.GeneratedMessage {
  ...
  factory SEN5XState.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory SEN5XState.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SEN5XState', package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'lastCleaningTime', $pb.PbFieldType.OU3)
    ..aOB(2, _omitFieldNames ? '' : 'lastCleaningValid')
    ..aOB(3, _omitFieldNames ? '' : 'oneShotMode')
    ..a<$core.int>(4, _omitFieldNames ? '' : 'vocStateTime', $pb.PbFieldType.OU3)
    ..aOB(5, _omitFieldNames ? '' : 'vocStateValid')
    ..a<$fixnum.Int64>(6, _omitFieldNames ? '' : 'vocStateArray', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SEN5XState clone() => SEN5XState()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SEN5XState copyWith(void Function(SEN5XState) updates) => super.copyWith((message) => updates(message as SEN5XState)) as SEN5XState;
  ...
  static $pb.PbList<SEN5XState> createRepeated() => $pb.PbList<SEN5XState>();
  @$core.pragma('dart2js:noInline')
  static SEN5XState getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SEN5XState>(create);
