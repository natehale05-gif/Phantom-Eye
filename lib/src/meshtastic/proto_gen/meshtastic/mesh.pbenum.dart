...
class HardwareModel extends $pb.ProtobufEnum {
  ...
  static const HardwareModel MAKERFABS_TRACKER = HardwareModel._(27, _omitEnumNames ? '' : 'MAKERFABS_TRACKER');
  ///
  ///  Makerfabs Reserved
  static const HardwareModel MAKERFABS_RESERVED = HardwareModel._(28, _omitEnumNames ? '' : 'MAKERFABS_RESERVED');
  ///
  ...
  static const HardwareModel T_ECHO_PLUS = HardwareModel._(33, _omitEnumNames ? '' : 'T_ECHO_PLUS');
  ///
  ///  TODO: REPLACE
  ...
  static const HardwareModel MUZI_BASE = HardwareModel._(93, _omitEnumNames ? '' : 'MUZI_BASE');
  ///
  ...
  static const HardwareModel WISMESH_TAP_V2 = HardwareModel._(116, _omitEnumNames ? '' : 'WISMESH_TAP_V2');
  ///
  ///  RAK3401
  static const HardwareModel RAK3401 = HardwareModel._(117, _omitEnumNames ? '' : 'RAK3401');
  ///
  ///  RAK6421 Hat+
  static const HardwareModel RAK6421 = HardwareModel._(118, _omitEnumNames ? '' : 'RAK6421');
  ///
  ///  Elecrow ThinkNode M4
  static const HardwareModel THINKNODE_M4 = HardwareModel._(119, _omitEnumNames ? '' : 'THINKNODE_M4');
  ///
  ///  Elecrow ThinkNode M6
  static const HardwareModel THINKNODE_M6 = HardwareModel._(120, _omitEnumNames ? '' : 'THINKNODE_M6');
  ///
  ///  Elecrow Meshstick 1262
  static const HardwareModel MESHSTICK_1262 = HardwareModel._(121, _omitEnumNames ? '' : 'MESHSTICK_1262');
  ///
  ///  LilyGo T-Beam 1W
  static const HardwareModel TBEAM_1_WATT = HardwareModel._(122, _omitEnumNames ? '' : 'TBEAM_1_WATT');
  ///
  ///  LilyGo T5 S3 ePaper Pro (V1 and V2)
  static const HardwareModel T5_S3_EPAPER_PRO = HardwareModel._(123, _omitEnumNames ? '' : 'T5_S3_EPAPER_PRO');
  ///
  ///  LilyGo T-Beam BPF (144-148Mhz)
  static const HardwareModel TBEAM_BPF = HardwareModel._(124, _omitEnumNames ? '' : 'TBEAM_BPF');
  ///
  ///  LilyGo T-Mini E-paper S3 Kit
  static const HardwareModel MINI_EPAPER_S3 = HardwareModel._(125, _omitEnumNames ? '' : 'MINI_EPAPER_S3');
  ///
  ///  LilyGo T-Display S3 Pro LR1121
  static const HardwareModel TDISPLAY_S3_PRO = HardwareModel._(126, _omitEnumNames ? '' : 'TDISPLAY_S3_PRO');
  ///
  ///  Heltec Mesh Node T096 board features an nRF52840 CPU and a TFT screen.
  static const HardwareModel HELTEC_MESH_NODE_T096 = HardwareModel._(127, _omitEnumNames ? '' : 'HELTEC_MESH_NODE_T096');
  ///
  ///  Seeed studio Mesh Tracker X1card. NRF52840 w/ LR2021 radio,
  ///  GPS, button, buzzer, and sensors.
  static const HardwareModel MESH_TRACKER_X1 = HardwareModel._(128, _omitEnumNames ? '' : 'MESH_TRACKER_X1');
  ///
  ///  Elecrow ThinkNode M7, M8 and M9
  static const HardwareModel THINKNODE_M7 = HardwareModel._(129, _omitEnumNames ? '' : 'THINKNODE_M7');
  static const HardwareModel THINKNODE_M8 = HardwareModel._(130, _omitEnumNames ? '' : 'THINKNODE_M8');
  static const HardwareModel THINKNODE_M9 = HardwareModel._(131, _omitEnumNames ? '' : 'THINKNODE_M9');
  ///
  ///  The Heltec-V4-R8 uses an ESP32S3R8 chip, plus an SX1262.
  static const HardwareModel HELTEC_V4_R8 = HardwareModel._(132, _omitEnumNames ? '' : 'HELTEC_V4_R8');
  ///
  ///  The HELTEC_MESH_NODE_T1 uses an NRF52840 chip, plus an SX1262.
  static const HardwareModel HELTEC_MESH_NODE_T1 = HardwareModel._(133, _omitEnumNames ? '' : 'HELTEC_MESH_NODE_T1');
  ///
  ///  B&Q Consulting Station G3: TBD
  static const HardwareModel STATION_G3 = HardwareModel._(134, _omitEnumNames ? '' : 'STATION_G3');
  ///
  ///  Lilygo T-Impulse-Plus
  static const HardwareModel T_IMPULSE_PLUS = HardwareModel._(135, _omitEnumNames ? '' : 'T_IMPULSE_PLUS');
  ///
  ///  Lilygo T-Echo Card
  static const HardwareModel T_ECHO_CARD = HardwareModel._(136, _omitEnumNames ? '' : 'T_ECHO_CARD');
  ///
  ///  Seeed Tracker L2
  static const HardwareModel SEEED_WIO_TRACKER_L2 = HardwareModel._(137, _omitEnumNames ? '' : 'SEEED_WIO_TRACKER_L2');
  ///
  ///  Elecrow CrowPanel Advance P4 models, ESP32-P4 and TFT with SX1262 radio plugin
  static const HardwareModel CROWPANEL_P4 = HardwareModel._(138, _omitEnumNames ? '' : 'CROWPANEL_P4');
  ///
  ///  Heltec Mesh Tower V2
  static const HardwareModel HELTEC_MESH_TOWER_V2 = HardwareModel._(139, _omitEnumNames ? '' : 'HELTEC_MESH_TOWER_V2');
  ///
  ///  Meshnology W10
  static const HardwareModel MESHNOLOGY_W10 = HardwareModel._(140, _omitEnumNames ? '' : 'MESHNOLOGY_W10');
  ///
  ///  Heltec ESP32S3 + SX1262
  static const HardwareModel HELTEC_RC32 = HardwareModel._(141, _omitEnumNames ? '' : 'HELTEC_RC32');
  ///
  ///  Heltec NRF52840 + SX1262
  static const HardwareModel HELTEC_RC52 = HardwareModel._(142, _omitEnumNames ? '' : 'HELTEC_RC52');
  ///
  ///  Heltec ESP32C6 + SX1262
  static const HardwareModel HELTEC_RCC6 = HardwareModel._(143, _omitEnumNames ? '' : 'HELTEC_RCC6');
  ///
  ///  ------------------------------------------------------------------------------------------------------------------------------------------
...
class CriticalErrorCode extends $pb.ProtobufEnum {
  ...
  static final $core.List<CriticalErrorCode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 13);
  static CriticalErrorCode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Position_LocSource extends $pb.ProtobufEnum {
  ...
  static final $core.List<Position_LocSource?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static Position_LocSource? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Position_AltSource extends $pb.ProtobufEnum {
  ...
  static final $core.List<Position_AltSource?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static Position_AltSource? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Routing_Error extends $pb.ProtobufEnum {
  ...
  static const Routing_Error PKI_SEND_FAIL_PUBLIC_KEY = Routing_Error._(39, _omitEnumNames ? '' : 'PKI_SEND_FAIL_PUBLIC_KEY');
...
class StoreForwardPlusPlus_SFPP_message_type extends $pb.ProtobufEnum {
  ...
  static const StoreForwardPlusPlus_SFPP_message_type CANON_ANNOUNCE = StoreForwardPlusPlus_SFPP_message_type._(0, _omitEnumNames ? '' : 'CANON_ANNOUNCE');
  ///
  ///  Query whether a specific link is on the chain
  static const StoreForwardPlusPlus_SFPP_message_type CHAIN_QUERY = StoreForwardPlusPlus_SFPP_message_type._(1, _omitEnumNames ? '' : 'CHAIN_QUERY');
  ///
  ///  Request the next link in the chain
  static const StoreForwardPlusPlus_SFPP_message_type LINK_REQUEST = StoreForwardPlusPlus_SFPP_message_type._(3, _omitEnumNames ? '' : 'LINK_REQUEST');
  ///
  ///  Provide a link to add to the chain
  static const StoreForwardPlusPlus_SFPP_message_type LINK_PROVIDE = StoreForwardPlusPlus_SFPP_message_type._(4, _omitEnumNames ? '' : 'LINK_PROVIDE');
  ///
  ///  If we must fragment, send the first half
  static const StoreForwardPlusPlus_SFPP_message_type LINK_PROVIDE_FIRSTHALF = StoreForwardPlusPlus_SFPP_message_type._(5, _omitEnumNames ? '' : 'LINK_PROVIDE_FIRSTHALF');
  ///
  ///  If we must fragment, send the second half
  static const StoreForwardPlusPlus_SFPP_message_type LINK_PROVIDE_SECONDHALF = StoreForwardPlusPlus_SFPP_message_type._(6, _omitEnumNames ? '' : 'LINK_PROVIDE_SECONDHALF');

  static const $core.List<StoreForwardPlusPlus_SFPP_message_type> values = <StoreForwardPlusPlus_SFPP_message_type> [
    CANON_ANNOUNCE,
    CHAIN_QUERY,
    LINK_REQUEST,
    LINK_PROVIDE,
  ...
  static final $core.List<StoreForwardPlusPlus_SFPP_message_type?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 6);
  static StoreForwardPlusPlus_SFPP_message_type? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class RemoteShell_OpCode extends $pb.ProtobufEnum {
  static const RemoteShell_OpCode OP_UNSET = RemoteShell_OpCode._(0, _omitEnumNames ? '' : 'OP_UNSET');
  /// Client -> server
  static const RemoteShell_OpCode OPEN = RemoteShell_OpCode._(1, _omitEnumNames ? '' : 'OPEN');
  static const RemoteShell_OpCode INPUT = RemoteShell_OpCode._(2, _omitEnumNames ? '' : 'INPUT');
  static const RemoteShell_OpCode RESIZE = RemoteShell_OpCode._(3, _omitEnumNames ? '' : 'RESIZE');
  static const RemoteShell_OpCode CLOSE = RemoteShell_OpCode._(4, _omitEnumNames ? '' : 'CLOSE');
  static const RemoteShell_OpCode PING = RemoteShell_OpCode._(5, _omitEnumNames ? '' : 'PING');
  static const RemoteShell_OpCode ACK = RemoteShell_OpCode._(6, _omitEnumNames ? '' : 'ACK');
  /// Server -> client
  static const RemoteShell_OpCode OPEN_OK = RemoteShell_OpCode._(64, _omitEnumNames ? '' : 'OPEN_OK');
  static const RemoteShell_OpCode OUTPUT = RemoteShell_OpCode._(65, _omitEnumNames ? '' : 'OUTPUT');
  static const RemoteShell_OpCode CLOSED = RemoteShell_OpCode._(66, _omitEnumNames ? '' : 'CLOSED');
  static const RemoteShell_OpCode ERROR = RemoteShell_OpCode._(67, _omitEnumNames ? '' : 'ERROR');
  static const RemoteShell_OpCode PONG = RemoteShell_OpCode._(68, _omitEnumNames ? '' : 'PONG');
  ...
  static final $core.Map<$core.int, RemoteShell_OpCode> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class MeshPacket_Delayed extends $pb.ProtobufEnum {
  ...
  static final $core.List<MeshPacket_Delayed?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static MeshPacket_Delayed? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class MeshPacket_TransportMechanism extends $pb.ProtobufEnum {
  ...
  static const MeshPacket_TransportMechanism TRANSPORT_UNICAST_UDP = MeshPacket_TransportMechanism._(8, _omitEnumNames ? '' : 'TRANSPORT_UNICAST_UDP');
  ...
  static final $core.List<MeshPacket_TransportMechanism?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
  static MeshPacket_TransportMechanism? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class LockdownStatus_State extends $pb.ProtobufEnum {
  ...
  static const LockdownStatus_State STATE_UNSPECIFIED = LockdownStatus_State._(0, _omitEnumNames ? '' : 'STATE_UNSPECIFIED');
  ///
  ///  No passphrase has ever been provisioned on this device.
  ///  Client should prompt the operator to set one.
  static const LockdownStatus_State NEEDS_PROVISION = LockdownStatus_State._(1, _omitEnumNames ? '' : 'NEEDS_PROVISION');
  ///
  ...
  static const LockdownStatus_State LOCKED = LockdownStatus_State._(2, _omitEnumNames ? '' : 'LOCKED');
  ///
  ...
  ///  token's TTL.
  static const LockdownStatus_State UNLOCKED = LockdownStatus_State._(3, _omitEnumNames ? '' : 'UNLOCKED');
  ///
  ///  Passphrase rejected. backoff_seconds is non-zero when rate-limited.
  static const LockdownStatus_State UNLOCK_FAILED = LockdownStatus_State._(4, _omitEnumNames ? '' : 'UNLOCK_FAILED');
  ///
  ...
  static const LockdownStatus_State DISABLED = LockdownStatus_State._(5, _omitEnumNames ? '' : 'DISABLED');
  ...
  static final $core.List<LockdownStatus_State?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 5);
  static LockdownStatus_State? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
