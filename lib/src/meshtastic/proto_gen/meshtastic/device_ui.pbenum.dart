...
class CompassMode extends $pb.ProtobufEnum {
  ...
  static final $core.List<CompassMode?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static CompassMode? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class Theme extends $pb.ProtobufEnum {
  ...
  static final $core.List<Theme?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static Theme? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class DeviceUIConfig_GpsCoordinateFormat extends $pb.ProtobufEnum {
  ...
  static final $core.List<DeviceUIConfig_GpsCoordinateFormat?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 6);
  static DeviceUIConfig_GpsCoordinateFormat? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
