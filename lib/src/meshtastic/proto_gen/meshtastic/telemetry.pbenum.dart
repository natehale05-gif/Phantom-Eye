...
class TelemetrySensorType extends $pb.ProtobufEnum {
  ...
  static const TelemetrySensorType HDC1080 = TelemetrySensorType._(46, _omitEnumNames ? '' : 'HDC1080');
  ///
  ///  TODO - REMOVE STH21 Temperature and R. Humidity sensor
  static const TelemetrySensorType SHT21 = TelemetrySensorType._(47, _omitEnumNames ? '' : 'SHT21');
  ///
  ///  Sensirion STC31 CO2 sensor
  static const TelemetrySensorType STC31 = TelemetrySensorType._(48, _omitEnumNames ? '' : 'STC31');
  ///
  ///  SCD30 CO2, humidity, temperature sensor
  static const TelemetrySensorType SCD30 = TelemetrySensorType._(49, _omitEnumNames ? '' : 'SCD30');
  ///
  ///  SHT family of sensors for temperature and humidity
  static const TelemetrySensorType SHTXX = TelemetrySensorType._(50, _omitEnumNames ? '' : 'SHTXX');
  ///
  ///  DS248X Bridge for one-wire temperature sensors
  static const TelemetrySensorType DS248X = TelemetrySensorType._(51, _omitEnumNames ? '' : 'DS248X');
  ///
  ///  MMC5983MA 3-Axis Digital Magnetic Sensor
  static const TelemetrySensorType MMC5983MA = TelemetrySensorType._(52, _omitEnumNames ? '' : 'MMC5983MA');
  ///
  ///  ICM-42607-P 6‑Axis IMU
  static const TelemetrySensorType ICM42607P = TelemetrySensorType._(53, _omitEnumNames ? '' : 'ICM42607P');
  ///
  ///  SPA06 pressure and temperature
  static const TelemetrySensorType SPA06 = TelemetrySensorType._(54, _omitEnumNames ? '' : 'SPA06');
  ...
  static final $core.List<TelemetrySensorType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 54);
  static TelemetrySensorType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
